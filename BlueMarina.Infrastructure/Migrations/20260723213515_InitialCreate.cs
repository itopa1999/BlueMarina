        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Refresh Token_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinancialGoalsJson = table.Column<string>(type: "jsonb", nullable: true),
                    ...
                    NextOfKinName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    NextOfKinPhone = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    NextOfKinRelationship = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_User Profile", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Address_User Profile_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bank Account", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Bank Account_User Profile_UserId",
                        column: x => x.UserId,
                        principalTable: "User Profile",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OcrExtractedData = table.Column<string>(type: "jsonb", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Kyc Document", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Kyc Document_User Profile_UserId",
                        column: x => x.UserId,
                        principalTable: "User Profile",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Kyc Verification", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Kyc Verification_User Profile_UserId",
                        column: x => x.UserId,
                        principalTable: "User Profile",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Address_IsVerified",
                table: "Address",
                column: "IsVerified");

            migrationBuilder.CreateIndex(
                name: "IX_Address_UserId_Type",
                table: "Address",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bank Account_BankCode_AccountNumber",
                table: "Bank Account",
                columns: new[] { "BankCode", "AccountNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Bank Account_UserId_Currency",
                table: "Bank Account",
                columns: new[] { "UserId", "Currency" });

            migrationBuilder.CreateIndex(
                name: "IX_Kyc Document_Status",
                table: "Kyc Document",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_Kyc Document_UserId_Type",
                table: "Kyc Document",
                columns: new[] { "UserId", "Type" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Kyc Verification_Result",
                table: "Kyc Verification",
                column: "Result");

            migrationBuilder.CreateIndex(
                name: "IX_Kyc Verification_UserId_Type",
                table: "Kyc Verification",
                columns: new[] { "UserId", "Type" });

            migrationBuilder.CreateIndex(
                name: "IX_Refresh Token_ExpiresAt",
                table: "Refresh Token",
                column: "ExpiresAt");

            migrationBuilder.CreateIndex(
                name: "IX_Refresh Token_TokenHash",
                table: "Refresh Token",
                column: "TokenHash",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_User Profile_Bvn",
                table: "User Profile",
                column: "Bvn",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_User Profile_KycLevel",
                table: "User Profile",
                column: "KycLevel");

            migrationBuilder.CreateIndex(
                name: "IX_User Profile_Nin",
                table: "User Profile",
                column: "Nin",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_User Profile_ReferralCode",
                table: "User Profile",
                column: "ReferralCode",
                unique: true);
